...
if(date_today.weekday() == update_day): 
    if(date_today.day in update_week):
        ...
        print(message)    
        PACKER_LOG_PATH = "/home/wellsud/logs/packer/"
        bashCommand = "PACKER_LOG=1 "+PACKER_LOG_PATH+" packer build -force ."
        changeWorkingDirectory = "/home/wellsud/imagens_servidores/builds/Windows/WindowsServer2019/Core/Standard/"
